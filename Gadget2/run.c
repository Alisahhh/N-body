...
void run(void)
{
	...
	do /* main loop */
	{
		...
		RDMA_MakeAll(&stopflag, 1, 0, MPI_COMM_WORLD);
...
void find_next_sync_point_and_drift(void)
{
	...
	RDMA_Allreduce(&min, &min_glob, 1, MPI_INT, MPI_MIN, MPI_COMM_WORLD);
	...
	RDMA_Allreduce(&flag, &Flag_FullStep, 1, MPI_INT, MPI_MIN, MPI_COMM_WORLD);
